<template>
    <div class="view">
        <div class="view-header">
            <h1 class="view-title"><i class="fa-solid fa-wand-magic-sparkles"></i> New Rule</h1>
        </div>
        ...
        <form class="rule-form" @submit.prevent="submit">
            ...
            <div class="form-actions">
                <FfButton variant="ghost" type="button" @click="router.push('/rules')">Cancel</FfButton>
                <FfButton variant="primary" type="submit" :loading="saving">Create rule</FfButton>
            </div>
        </form>
    </div>
</template>
